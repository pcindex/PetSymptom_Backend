...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Pet_Owner',
            fields=[
                ('user_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='api.account')),
        ...
        migrations.CreateModel(
            name='Veterinarian',
            fields=[
                ('vet_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='api.account')),
                ('name', models.CharField(max_length=100)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conditions', models.ManyToManyField(to='api.conditions')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.pet_owner')),
            ],
        ),
        migrations.CreateModel(
            name='Exam',
            fields=[
                ...
                ('pet', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='api.pets')),
                ('vet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.veterinarian')),
            ],
        ),
        migrations.CreateModel(
            name='Appointment_Offer',
            fields=[
                ...
                ('symptoms_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.symptoms')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.pet_owner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField()),
                ('exam_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.exam')),
                ('offer_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.appointment_offer')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.pet_owner')),
                ('vet_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.veterinarian')),
            ],
        ),
    ]
